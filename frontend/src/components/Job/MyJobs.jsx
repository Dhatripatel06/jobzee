                        ...
                        {element.fixedSalary ? (
                          ...
                          <div className="flex gap-2">
                            <input
                              ...
                              placeholder="From"
                              className={`w-1/2 px-4 py-2.5 rounded-lg border-2 transition-all duration-200 ${
                                editingMode === element._id
                                  ? "border-[#2d5649] bg-white focus:ring-2 focus:ring-[#2d5649] focus:ring-opacity-50"
                                  : "border-gray-200 bg-gray-50 cursor-not-allowed"
                              } outline-none`}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          className={`w-full px-4 py-2.5 rounded-lg border-2 transition-all duration-200 resize-none ${
                            editingMode === element._id
                              ? "border-[#2d5649] bg-white focus:ring-2 focus:ring-[#2d5649] focus:ring-opacity-50"
                              : "border-gray-200 bg-gray-50 cursor-not-allowed"
                          } outline-none`}
